...
public class GenTest2 {
    public static int Start_Date = 22;
    public static int End_Date = 22;
    ...
    public static class TimeTable implements Writable {
        ...
        public void Add_Info(int hour,int day,int fre){
            if((hour < 24 && hour >= 0))
                Hour_Data[hour][day - Start_Date] += fre;
        }
    ...
    public static class GenTestMapper extends Mapper<LongWritable,Text,Text,TimeTable>
    {
        ...
        public void map(LongWritable key, Text value, Context context) throws IOException,InterruptedException
        {
            ...
            if(log.length != 10)
                ...
                String Hour_Key = log[1].substring(13, 15);
                String Min_Key = log[1].substring(16, 18);
                String Second_Key = log[1].substring(19, 21);
                ...
                if(!(Integer.parseInt(Day_Key) >= Start_Date && Integer.parseInt(Day_Key) <= End_Date))
                    return ;
            ...
            for(TimeTable t : values)
            {
                ...
                for (int i = 0; i < 24 ;i++)
                    for (int j = 0; j < End_Date - Start_Date + 1;j++) {
                        ...
                        result.Add_Info(i,j + Start_Date,temp);
                    }
            }
    ...
    public static class GenTestReducer extends Reducer<Text,TimeTable,Text,Text> {
        ...
        public void reduce(Text key,Iterable<TimeTable> values,Context context) throws IOException,InterruptedException
        {
            ...
            for (int i = 0; i < 24; i++)
            {
                ...
                mos.write("GenTest2",new Text(hour_window),line,output_path + "/"+key);
            }
    ...
    public static void main(String [] args)
    {
        try
        {
            ...
            Job job = Job.getInstance(conf,"GenTest2");
           ...
           //  //       String regex = "(?!.*2015-09-22).*$";
            ...
            MultipleOutputs.addNamedOutput(job,"GenTest2",LogTextOutputFormat.class,Text.class,Text.class);
