...
public class SimpleAverage {
    //简单平均方法进行预测
    public static class SimpleAverageMapper extends Mapper<LongWritable, Text, Text, Text>
    {
        ...
        public void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException
        {
            ...
            if(day.length == days+1)//1列时间+数据
            {
                ...
                double res = sum/14;
                prediction.write("SimpleAverage",new Text(day[0]), new Text( String.format("%.2f", res)), out_path+"/"+interface_name );
            }
        }
    ...
    public static void main(String[] args)
    {
        ...
        try{
            ...
            job.setMapperClass(SimpleAverage.SimpleAverageMapper.class);
            ...
            MultipleOutputs.addNamedOutput(job, "SimpleAverage", LogTextOutputFormat.class, Text.class, Text.class);
